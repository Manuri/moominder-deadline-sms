...
/**
 * Strings for deadline SMS plugin
 * @package blocks
...
$string['enabled'] = "<h5>You have enabled the deadline sms service...!</h5>";
$string['disabled'] = "<h5>You have disabled the deadline sms service..!</h5>";
$string['have_subscribed'] = 'You have subscribed already';
